...
const RequestUsername = ({requestedUsername, requestedUsernameChange, saveRequestedUsername}) => (
    <div className="main-panel-div">
        ...
        <div className="upload-form-div">
            ...
            <br/>
            <form className="form-inline" onSubmit={saveRequestedUsername}>
                <div className="form-group row">
                    <label className="col-sm-2">Username:</label>
                    <div className="col-sm-10">
                        <input type="text"
                               className="form-control username-input"
                               onChange={requestedUsernameChange}
